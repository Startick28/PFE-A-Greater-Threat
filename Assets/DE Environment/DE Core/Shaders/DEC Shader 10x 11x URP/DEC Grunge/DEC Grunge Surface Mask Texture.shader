...
Shader "DEC/Grunge/Grunge Surface Mask Texture"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 float4switch1476_g39660( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 float4switch1269_g39660( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 float4switch1400_g39660( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 float4switch1377_g39660( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 float4switch1491_g39660( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 float4switch1380_g39660( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch1329_g39660( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch1413_g39660( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch1416_g39660( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch1434_g39660( int m_switch, float m_Off, float m_Active, float m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch1435_g39660( int m_switch, float m_Off, float m_Active, float m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch1436_g39660( int m_switch, float m_Off, float m_Active, float m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch1075_g39660( int m_switch, float m_Off, float m_Active, float m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch1432_g39660( int m_switch, float m_Off, float m_Active, float m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch1433_g39660( int m_switch, float m_Off, float m_Active, float m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
						 ...
						 ) : SV_Target
			{
				...
				int m_switch1380_g39660 = _Curvaturewear_Mode;
				int m_switch1377_g39660 = _Verticalwear_Mode;
				int m_switch1269_g39660 = _Horizontalwear_Mode;
				...
				float4 temp_output_6_0_g39660 = ( temp_output_7_0_g38079 + float4(0,0,0,0) );
				float4 m_Off1269_g39660 = temp_output_6_0_g39660;
				float2 appendResult1344_g39660 = (float2(_Horizontalwear_TilingX , _Horizontalwear_TilingY));
				float2 appendResult1343_g39660 = (float2(_Horizontalwear_OffsetX , _Horizontalwear_OffsetY));
				float2 texCoord1342_g39660 = IN.ase_texcoord8.xy * appendResult1344_g39660 + appendResult1343_g39660;
				float4 tex2DNode1327_g39660 = SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMap, sampler_trilinear_repeat, texCoord1342_g39660 );
				float4 temp_output_12_0_g39663 = ( float4( (_Horizontalwear_Tint).rgb , 0.0 ) * tex2DNode1327_g39660 );
				float3 desaturateInitialColor10_g39663 = temp_output_12_0_g39663.xyz;
				float desaturateDot10_g39663 = dot( desaturateInitialColor10_g39663, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar10_g39663 = lerp( desaturateInitialColor10_g39663, desaturateDot10_g39663.xxx, ( 1.0 - ( _Horizontalwear_Saturation + 1.0 ) ) );
				float3 FINAL_MASK_HORIZONTAL804_g39660 = desaturateVar10_g39663;
				float4 temp_cast_15 = (0.5).xxxx;
				float4 temp_cast_16 = (0.75).xxxx;
				int _Horizontalwear_Mode1003_g39660 = _Horizontalwear_Mode;
				int m_switch1476_g39660 = _Horizontalwear_Mode1003_g39660;
				float2 texCoord794_g39660 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39683 = cos( radians( _Horizontalwear_Rotation ) );
				float sin1_g39683 = sin( radians( _Horizontalwear_Rotation ) );
				float2 rotator1_g39683 = mul( texCoord794_g39660 - float2( 0.5,0.5 ) , float2x2( cos1_g39683 , -sin1_g39683 , sin1_g39683 , cos1_g39683 )) + float2( 0.5,0.5 );
				float2 appendResult811_g39660 = (float2(_Horizontalwear_TilingXMask , _Horizontalwear_TilingYMask));
				float2 appendResult1164_g39660 = (float2(_Horizontalwear_OffsetXMask , _Horizontalwear_OffsetYMask));
				float4 m_Off1476_g39660 = SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39683*appendResult811_g39660 + appendResult1164_g39660) );
				float4 m_Active1476_g39660 = SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39683*appendResult811_g39660 + appendResult1164_g39660) );
				float4 m_ActiveInverted1476_g39660 = saturate( ( 1.0 - SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39683*appendResult811_g39660 + appendResult1164_g39660) ) ) );
				float4 localfloat4switch1476_g39660 = float4switch1476_g39660( m_switch1476_g39660 , m_Off1476_g39660 , m_Active1476_g39660 , m_ActiveInverted1476_g39660 );
				float4 temp_output_44_0_g39690 = localfloat4switch1476_g39660;
				float4 VECTOR_IN212_g39690 = temp_output_44_0_g39690;
				float4 _Vec = float4(0.001,0.001,0.001,0.001);
				float4 Vect_0019_g39690 = _Vec;
				float2 _SmoothHorizontal = float2(0,0.5);
				float3 temp_output_40_0_g39690 = abs( WorldNormal );
				float WN_HORIZONTAL141_g39690 = ( ( temp_output_40_0_g39690 * temp_output_40_0_g39690 ).y + 0.07 );
				float smoothstepResult205_g39690 = smoothstep( _SmoothHorizontal.x , _SmoothHorizontal.y , ( ( 1.0 - WN_HORIZONTAL141_g39690 ) + -0.1 ));
				float4 lerpResult200_g39690 = lerp( VECTOR_IN212_g39690 , Vect_0019_g39690 , smoothstepResult205_g39690);
				float4 MASK_HORIZONTAL204_g39690 = lerpResult200_g39690;
				float4 temp_cast_20 = (_Horizontalwear_BlendStrength).xxxx;
				float4 temp_cast_21 = (-1.0).xxxx;
				float4 smoothstepResult75_g39690 = smoothstep( temp_cast_15 , temp_cast_16 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_HORIZONTAL204_g39690 ) - temp_cast_20) * (temp_cast_21 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_20)));
				float4 _MinOldVect4 = float4(0,0,0,0);
				float MASK_HORIZONTAL808_g39660 = ( (( ( smoothstepResult75_g39690 - _MinOldVect4 ) / ( float4(1,1,1,1) - _MinOldVect4 ) )).x * _Horizontalwear_BlendMix );
				float4 lerpResult861_g39660 = lerp( temp_output_6_0_g39660 , float4( FINAL_MASK_HORIZONTAL804_g39660 , 0.0 ) , MASK_HORIZONTAL808_g39660);
				float4 m_Active1269_g39660 = lerpResult861_g39660;
				float4 m_ActiveInverted1269_g39660 = lerpResult861_g39660;
				float4 localfloat4switch1269_g39660 = float4switch1269_g39660( m_switch1269_g39660 , m_Off1269_g39660 , m_Active1269_g39660 , m_ActiveInverted1269_g39660 );
				float4 m_Off1377_g39660 = localfloat4switch1269_g39660;
				float2 appendResult1384_g39660 = (float2(_Verticalwear_TilingX , _Verticalwear_TilingY));
				float2 appendResult1386_g39660 = (float2(_Verticalwear_OffsetX , _Verticalwear_OffsetY));
				float2 texCoord1388_g39660 = IN.ase_texcoord8.xy * appendResult1384_g39660 + appendResult1386_g39660;
				float4 tex2DNode1397_g39660 = SAMPLE_TEXTURE2D( _Verticalwear_GrungeMap, sampler_trilinear_repeat, texCoord1388_g39660 );
				float4 temp_output_12_0_g39675 = ( float4( (_Verticalwear_Tint).rgb , 0.0 ) * tex2DNode1397_g39660 );
				float3 desaturateInitialColor10_g39675 = temp_output_12_0_g39675.xyz;
				float desaturateDot10_g39675 = dot( desaturateInitialColor10_g39675, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar10_g39675 = lerp( desaturateInitialColor10_g39675, desaturateDot10_g39675.xxx, ( 1.0 - ( _Verticalwear_Saturation + 1.0 ) ) );
				float3 FINAL_MASK_VERTICAL394_g39660 = desaturateVar10_g39675;
				float4 temp_cast_26 = (0.5).xxxx;
				float4 temp_cast_27 = (0.75).xxxx;
				int _Verticalwear_Mode1004_g39660 = _Verticalwear_Mode;
				int m_switch1400_g39660 = _Verticalwear_Mode1004_g39660;
				float2 texCoord1584_g39660 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39677 = cos( radians( _Verticalwear_Rotation ) );
				float sin1_g39677 = sin( radians( _Verticalwear_Rotation ) );
				float2 rotator1_g39677 = mul( texCoord1584_g39660 - float2( 0.5,0.5 ) , float2x2( cos1_g39677 , -sin1_g39677 , sin1_g39677 , cos1_g39677 )) + float2( 0.5,0.5 );
				float2 appendResult41_g39660 = (float2(_Verticalwear_TilingXMask , _Verticalwear_TilingYMask));
				float2 appendResult1165_g39660 = (float2(_Verticalwear_OffsetXMask , _Verticalwear_OffsetYMask));
				float4 m_Off1400_g39660 = SAMPLE_TEXTURE2D( _Verticalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39677*appendResult41_g39660 + appendResult1165_g39660) );
				float4 m_Active1400_g39660 = SAMPLE_TEXTURE2D( _Verticalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39677*appendResult41_g39660 + appendResult1165_g39660) );
				float4 m_ActiveInverted1400_g39660 = saturate( ( 1.0 - SAMPLE_TEXTURE2D( _Verticalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39677*appendResult41_g39660 + appendResult1165_g39660) ) ) );
				float4 localfloat4switch1400_g39660 = float4switch1400_g39660( m_switch1400_g39660 , m_Off1400_g39660 , m_Active1400_g39660 , m_ActiveInverted1400_g39660 );
				float4 temp_output_44_0_g39661 = localfloat4switch1400_g39660;
				float3 temp_output_40_0_g39661 = abs( WorldNormal );
				float WN_HORIZONTAL141_g39661 = ( ( temp_output_40_0_g39661 * temp_output_40_0_g39661 ).y + 0.07 );
				float4 lerpResult2_g39661 = lerp( temp_output_44_0_g39661 , _Vec , WN_HORIZONTAL141_g39661);
				float4 VECTOR_IN_MASKED112_g39661 = lerpResult2_g39661;
				float4 Vect_0019_g39661 = _Vec;
				float3 break349_g39661 = WorldNormal;
				float WN_NY173_g39661 = break349_g39661.y;
				float WN_NZ184_g39661 = break349_g39661.z;
				float WN_NX186_g39661 = break349_g39661.x;
				float temp_output_175_0_g39661 = ( -WN_NY173_g39661 + WN_NZ184_g39661 + -WN_NX186_g39661 );
				float4 lerpResult133_g39661 = lerp( VECTOR_IN_MASKED112_g39661 , Vect_0019_g39661 , ( temp_output_175_0_g39661 + -temp_output_175_0_g39661 + 0.07 ));
				float4 MASK_SIDE163_g39661 = lerpResult133_g39661;
				float4 temp_cast_31 = (_Verticalwear_BlendStrength).xxxx;
				float4 temp_cast_32 = (-2.0).xxxx;
				float4 smoothstepResult75_g39661 = smoothstep( temp_cast_26 , temp_cast_27 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_SIDE163_g39661 ) - temp_cast_31) * (temp_cast_32 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_31)));
				float MASK_VERTICAL602_g39660 = ( (( ( smoothstepResult75_g39661 - _MinOldVect4 ) / ( float4(1,1,1,1) - _MinOldVect4 ) )).x * _Verticalwear_BlendMix );
				float4 lerpResult1227_g39660 = lerp( localfloat4switch1269_g39660 , float4( FINAL_MASK_VERTICAL394_g39660 , 0.0 ) , MASK_VERTICAL602_g39660);
				float4 m_Active1377_g39660 = lerpResult1227_g39660;
				float4 m_ActiveInverted1377_g39660 = lerpResult1227_g39660;
				float4 localfloat4switch1377_g39660 = float4switch1377_g39660( m_switch1377_g39660 , m_Off1377_g39660 , m_Active1377_g39660 , m_ActiveInverted1377_g39660 );
				float4 m_Off1380_g39660 = localfloat4switch1377_g39660;
				float4 ALBEDO_IN1447_g39660 = temp_output_6_0_g39660;
				float2 appendResult1393_g39660 = (float2(_Curvaturewear_TilingX , _Curvaturewear_TilingY));
				float2 appendResult1390_g39660 = (float2(_Curvaturewear_OffsetX , _Curvaturewear_OffsetY));
				float2 texCoord1389_g39660 = IN.ase_texcoord8.xy * appendResult1393_g39660 + appendResult1390_g39660;
				float4 tex2DNode1396_g39660 = SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMap, sampler_trilinear_repeat, texCoord1389_g39660 );
				float4 temp_output_12_0_g39667 = ( float4( (_Curvaturewear_Tint).rgb , 0.0 ) * tex2DNode1396_g39660 );
				float3 desaturateInitialColor10_g39667 = temp_output_12_0_g39667.xyz;
				float desaturateDot10_g39667 = dot( desaturateInitialColor10_g39667, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar10_g39667 = lerp( desaturateInitialColor10_g39667, desaturateDot10_g39667.xxx, ( 1.0 - ( _Curvaturewear_Saturation + 1.0 ) ) );
				float4 lerpResult1544_g39660 = lerp( ALBEDO_IN1447_g39660 , float4( desaturateVar10_g39667 , 0.0 ) , _Curvaturewear_BlendMix);
				float4 FINAL_MASK_CURVATURE586_g39660 = lerpResult1544_g39660;
				float4 temp_cast_37 = (0.5).xxxx;
				float4 temp_cast_38 = (0.75).xxxx;
				int _Curvaturewear_Mode398_g39660 = _Curvaturewear_Mode;
				int m_switch1491_g39660 = _Curvaturewear_Mode398_g39660;
				float2 texCoord28_g39660 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39692 = cos( radians( _Curvaturewear_Rotation ) );
				float sin1_g39692 = sin( radians( _Curvaturewear_Rotation ) );
				float2 rotator1_g39692 = mul( texCoord28_g39660 - float2( 0.5,0.5 ) , float2x2( cos1_g39692 , -sin1_g39692 , sin1_g39692 , cos1_g39692 )) + float2( 0.5,0.5 );
				float2 appendResult38_g39660 = (float2(_Curvaturewear_TilingXMask , _Curvaturewear_TilingYMask));
				float2 appendResult1168_g39660 = (float2(_Curvaturewear_OffsetXMask , _Curvaturewear_OffsetYMask));
				float4 m_Off1491_g39660 = SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39692*appendResult38_g39660 + appendResult1168_g39660) );
				float4 m_Active1491_g39660 = SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39692*appendResult38_g39660 + appendResult1168_g39660) );
				float4 m_ActiveInverted1491_g39660 = saturate( ( 1.0 - SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39692*appendResult38_g39660 + appendResult1168_g39660) ) ) );
				float4 localfloat4switch1491_g39660 = float4switch1491_g39660( m_switch1491_g39660 , m_Off1491_g39660 , m_Active1491_g39660 , m_ActiveInverted1491_g39660 );
				float4 temp_output_44_0_g39669 = localfloat4switch1491_g39660;
				float3 temp_output_40_0_g39669 = abs( WorldNormal );
				float WN_HORIZONTAL141_g39669 = ( ( temp_output_40_0_g39669 * temp_output_40_0_g39669 ).y + 0.07 );
				float4 lerpResult2_g39669 = lerp( temp_output_44_0_g39669 , _Vec , WN_HORIZONTAL141_g39669);
				float4 VECTOR_IN_MASKED112_g39669 = lerpResult2_g39669;
				float4 Vect_0019_g39669 = _Vec;
				float2 _SmoothX = float2(0,0.45);
				float3 temp_cast_42 = (0.5).xxx;
				float3 break24_g39669 = ( temp_output_40_0_g39669 - temp_cast_42 );
				float WN_X134_g39669 = break24_g39669.x;
				float smoothstepResult8_g39669 = smoothstep( _SmoothX.x , _SmoothX.y , ( WN_X134_g39669 + 1.25 ));
				float smoothstepResult22_g39669 = smoothstep( _SmoothX.x , _SmoothX.y , ( -WN_X134_g39669 + 0.02 ));
				float lerpResult11_g39669 = lerp( 0.0 , smoothstepResult8_g39669 , smoothstepResult22_g39669);
				float4 lerpResult14_g39669 = lerp( VECTOR_IN_MASKED112_g39669 , Vect_0019_g39669 , lerpResult11_g39669);
				float4 MASK_VERTICAL_X159_g39669 = lerpResult14_g39669;
				float2 _SmoothY = float2(0,0.85);
				float WN_Y135_g39669 = break24_g39669.y;
				float smoothstepResult29_g39669 = smoothstep( _SmoothY.x , _SmoothY.y , ( -WN_Y135_g39669 + 0.35 ));
				float4 lerpResult6_g39669 = lerp( VECTOR_IN_MASKED112_g39669 , Vect_0019_g39669 , smoothstepResult29_g39669);
				float4 MASK_VERTICAL_Y157_g39669 = lerpResult6_g39669;
				float2 _SmoothZ = float2(1.8,1.4);
				float WN_Z136_g39669 = break24_g39669.z;
				float smoothstepResult26_g39669 = smoothstep( _SmoothZ.x , _SmoothZ.y , ( WN_Z136_g39669 + 2.06 ));
				float lerpResult34_g39669 = lerp( smoothstepResult26_g39669 , 0.0 , ( -WN_Z136_g39669 + 2.05 ));
				float4 lerpResult5_g39669 = lerp( Vect_0019_g39669 , VECTOR_IN_MASKED112_g39669 , lerpResult34_g39669);
				float4 MASK_VERTICAL_Z155_g39669 = lerpResult5_g39669;
				float4 temp_cast_43 = (_Curvaturewear_BlendStrength).xxxx;
				float4 temp_cast_44 = (_Curvaturewear_BlendHardness).xxxx;
				float4 smoothstepResult75_g39669 = smoothstep( temp_cast_37 , temp_cast_38 , (float4( 0,0,0,0 ) + (( 1.0 - ( MASK_VERTICAL_X159_g39669 + MASK_VERTICAL_Y157_g39669 + MASK_VERTICAL_Z155_g39669 ) ) - temp_cast_43) * (temp_cast_44 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_43)));
				float MASK_CURVATURE401_g39660 = (( ( smoothstepResult75_g39669 - _MinOldVect4 ) / ( float4(1,1,1,1) - _MinOldVect4 ) )).x;
				float4 lerpResult860_g39660 = lerp( FINAL_MASK_CURVATURE586_g39660 , localfloat4switch1377_g39660 , MASK_CURVATURE401_g39660);
				float4 m_Active1380_g39660 = lerpResult860_g39660;
				float4 m_ActiveInverted1380_g39660 = lerpResult860_g39660;
				float4 localfloat4switch1380_g39660 = float4switch1380_g39660( m_switch1380_g39660 , m_Off1380_g39660 , m_Active1380_g39660 , m_ActiveInverted1380_g39660 );
				
				int m_switch1416_g39660 = _Curvaturewear_Mode;
				int m_switch1413_g39660 = _Verticalwear_Mode;
				int m_switch1329_g39660 = _Horizontalwear_Mode;
				...
				float3 temp_output_8_0_g39660 = ( temp_output_1478_59_g38079 + ADDITIONAL_LIGHT1342_g38079 );
				float3 m_Off1329_g39660 = temp_output_8_0_g39660;
				float4 temp_output_1_0_g39673 = SAMPLE_TEXTURE2D( _Horizontalwear_GrungeNormal, sampler_trilinear_repeat, texCoord1342_g39660 );
				float temp_output_8_0_g39673 = ( _Horizontalwear_NormalMultiplier * _Horizontalwear_BlendStrength );
				float3 unpack52_g39673 = UnpackNormalScale( temp_output_1_0_g39673, temp_output_8_0_g39673 );
				unpack52_g39673.z = lerp( 1, unpack52_g39673.z, saturate(temp_output_8_0_g39673) );
				float3 FINAL_MASKNORMAL_HORIZONTAL803_g39660 = unpack52_g39673;
				float3 lerpResult1335_g39660 = lerp( temp_output_8_0_g39660 , FINAL_MASKNORMAL_HORIZONTAL803_g39660 , MASK_HORIZONTAL808_g39660);
				float3 m_Active1329_g39660 = lerpResult1335_g39660;
				float3 m_ActiveInverted1329_g39660 = lerpResult1335_g39660;
				float3 localfloat3switch1329_g39660 = float3switch1329_g39660( m_switch1329_g39660 , m_Off1329_g39660 , m_Active1329_g39660 , m_ActiveInverted1329_g39660 );
				float3 m_Off1413_g39660 = localfloat3switch1329_g39660;
				float4 temp_output_1_0_g39671 = SAMPLE_TEXTURE2D( _Verticalwear_GrungeNormal, sampler_trilinear_repeat, texCoord1388_g39660 );
				float temp_output_8_0_g39671 = ( _Verticalwear_NormalMultiplier * _Verticalwear_BlendStrength );
				float3 unpack52_g39671 = UnpackNormalScale( temp_output_1_0_g39671, temp_output_8_0_g39671 );
				unpack52_g39671.z = lerp( 1, unpack52_g39671.z, saturate(temp_output_8_0_g39671) );
				float3 FINAL_MASKNORMAL_VERTICAL630_g39660 = unpack52_g39671;
				float3 lerpResult1414_g39660 = lerp( localfloat3switch1329_g39660 , FINAL_MASKNORMAL_VERTICAL630_g39660 , MASK_VERTICAL602_g39660);
				float3 m_Active1413_g39660 = lerpResult1414_g39660;
				float3 m_ActiveInverted1413_g39660 = lerpResult1414_g39660;
				float3 localfloat3switch1413_g39660 = float3switch1413_g39660( m_switch1413_g39660 , m_Off1413_g39660 , m_Active1413_g39660 , m_ActiveInverted1413_g39660 );
				float3 m_Off1416_g39660 = localfloat3switch1413_g39660;
				float3 NORMAL_IN1546_g39660 = temp_output_8_0_g39660;
				float4 temp_output_1_0_g39665 = SAMPLE_TEXTURE2D( _Curvaturewear_GrungeNormal, sampler_trilinear_repeat, texCoord1389_g39660 );
				float temp_output_8_0_g39665 = ( _Curvaturewear_NormalMultiplier * _Curvaturewear_BlendStrength );
				float3 unpack52_g39665 = UnpackNormalScale( temp_output_1_0_g39665, temp_output_8_0_g39665 );
				unpack52_g39665.z = lerp( 1, unpack52_g39665.z, saturate(temp_output_8_0_g39665) );
				float3 lerpResult1537_g39660 = lerp( NORMAL_IN1546_g39660 , unpack52_g39665 , _Curvaturewear_BlendMix);
				float3 FINAL_MASKNORMAL_CURVATURE599_g39660 = lerpResult1537_g39660;
				float3 lerpResult1417_g39660 = lerp( FINAL_MASKNORMAL_CURVATURE599_g39660 , localfloat3switch1413_g39660 , MASK_CURVATURE401_g39660);
				float3 m_Active1416_g39660 = lerpResult1417_g39660;
				float3 m_ActiveInverted1416_g39660 = lerpResult1417_g39660;
				float3 localfloat3switch1416_g39660 = float3switch1416_g39660( m_switch1416_g39660 , m_Off1416_g39660 , m_Active1416_g39660 , m_ActiveInverted1416_g39660 );
				
				int m_switch1436_g39660 = _Curvaturewear_Mode;
				int m_switch1435_g39660 = _Verticalwear_Mode;
				int m_switch1434_g39660 = _Horizontalwear_Mode;
				float4 _MASK_B1440_g38079 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_977_0_g39660 = ( _MetallicStrength * _MASK_B1440_g38079 );
				float m_Off1434_g39660 = temp_output_977_0_g39660.x;
				float FINAL_MASKMETALLIC_HORIZONTAL1026_g39660 = _Horizontalwear_Metallic;
				float4 temp_cast_52 = (FINAL_MASKMETALLIC_HORIZONTAL1026_g39660).xxxx;
				float4 lerpResult1439_g39660 = lerp( temp_output_977_0_g39660 , temp_cast_52 , MASK_HORIZONTAL808_g39660);
				float m_Active1434_g39660 = lerpResult1439_g39660.x;
				float m_ActiveInverted1434_g39660 = lerpResult1439_g39660.x;
				float localfloatswitch1434_g39660 = floatswitch1434_g39660( m_switch1434_g39660 , m_Off1434_g39660 , m_Active1434_g39660 , m_ActiveInverted1434_g39660 );
				float m_Off1435_g39660 = localfloatswitch1434_g39660;
				float FINAL_MASKMETALLIC_VERTICAL1024_g39660 = _Verticalwear_Metallic;
				float lerpResult1438_g39660 = lerp( localfloatswitch1434_g39660 , FINAL_MASKMETALLIC_VERTICAL1024_g39660 , MASK_VERTICAL602_g39660);
				float m_Active1435_g39660 = lerpResult1438_g39660;
				float m_ActiveInverted1435_g39660 = lerpResult1438_g39660;
				float localfloatswitch1435_g39660 = floatswitch1435_g39660( m_switch1435_g39660 , m_Off1435_g39660 , m_Active1435_g39660 , m_ActiveInverted1435_g39660 );
				float m_Off1436_g39660 = localfloatswitch1435_g39660;
				float4 METALLIC_IN1555_g39660 = temp_output_977_0_g39660;
				float4 temp_cast_55 = (_Curvaturewear_Metallic).xxxx;
				float4 lerpResult1553_g39660 = lerp( METALLIC_IN1555_g39660 , temp_cast_55 , _Curvaturewear_BlendMix);
				float4 FINAL_MASKMETALLIC_CURVATURE1022_g39660 = lerpResult1553_g39660;
				float4 temp_cast_56 = (localfloatswitch1435_g39660).xxxx;
				float4 lerpResult1437_g39660 = lerp( FINAL_MASKMETALLIC_CURVATURE1022_g39660 , temp_cast_56 , MASK_CURVATURE401_g39660);
				float m_Active1436_g39660 = lerpResult1437_g39660.x;
				float m_ActiveInverted1436_g39660 = lerpResult1437_g39660.x;
				float localfloatswitch1436_g39660 = floatswitch1436_g39660( m_switch1436_g39660 , m_Off1436_g39660 , m_Active1436_g39660 , m_ActiveInverted1436_g39660 );
				
				int m_switch1433_g39660 = _Curvaturewear_Mode;
				int m_switch1432_g39660 = _Verticalwear_Mode;
				int m_switch1075_g39660 = _Horizontalwear_Mode;
				...
				float4 temp_cast_61 = (ALBEDO_R169_g38079).xxxx;
				...
				float4 lerpResult11_g38079 = lerp( _MASK_R1439_g38079 , temp_cast_63 , (float)_OcclusionSourceMode);
				float4 lerpResult14_g38079 = lerp( color301_g38079 , lerpResult11_g38079 , _OcclusionStrengthAO);
				float4 temp_output_989_0_g39660 = ( temp_output_1267_33_g38079 * lerpResult14_g38079 );
				float m_Off1075_g39660 = temp_output_989_0_g39660.x;
				float FINAL_MASKSMOOTHNESS_HORIZONTAL1025_g39660 = _Horizontalwear_Smoothness;
				float4 temp_cast_67 = (FINAL_MASKSMOOTHNESS_HORIZONTAL1025_g39660).xxxx;
				float4 lerpResult1030_g39660 = lerp( temp_output_989_0_g39660 , temp_cast_67 , MASK_HORIZONTAL808_g39660);
				float m_Active1075_g39660 = lerpResult1030_g39660.x;
				float m_ActiveInverted1075_g39660 = lerpResult1030_g39660.x;
				float localfloatswitch1075_g39660 = floatswitch1075_g39660( m_switch1075_g39660 , m_Off1075_g39660 , m_Active1075_g39660 , m_ActiveInverted1075_g39660 );
				float m_Off1432_g39660 = localfloatswitch1075_g39660;
				float FINAL_MASKSMOOTHNESS_VERTICAL1023_g39660 = _Verticalwear_Smoothness;
				float lerpResult1028_g39660 = lerp( localfloatswitch1075_g39660 , FINAL_MASKSMOOTHNESS_VERTICAL1023_g39660 , MASK_VERTICAL602_g39660);
				float m_Active1432_g39660 = lerpResult1028_g39660;
				float m_ActiveInverted1432_g39660 = lerpResult1028_g39660;
				float localfloatswitch1432_g39660 = floatswitch1432_g39660( m_switch1432_g39660 , m_Off1432_g39660 , m_Active1432_g39660 , m_ActiveInverted1432_g39660 );
				float m_Off1433_g39660 = localfloatswitch1432_g39660;
				float4 SMOOTHNESS_IN1554_g39660 = temp_output_989_0_g39660;
				float4 temp_cast_70 = (_Curvaturewear_Smoothness).xxxx;
				float4 lerpResult1552_g39660 = lerp( SMOOTHNESS_IN1554_g39660 , temp_cast_70 , _Curvaturewear_BlendMix);
				float4 FINAL_MASKSMOOTHNESS_CURVATURE1021_g39660 = lerpResult1552_g39660;
				float4 temp_cast_71 = (localfloatswitch1432_g39660).xxxx;
				float4 lerpResult1031_g39660 = lerp( FINAL_MASKSMOOTHNESS_CURVATURE1021_g39660 , temp_cast_71 , MASK_CURVATURE401_g39660);
				float m_Active1433_g39660 = lerpResult1031_g39660.x;
				float m_ActiveInverted1433_g39660 = lerpResult1031_g39660.x;
				float localfloatswitch1433_g39660 = floatswitch1433_g39660( m_switch1433_g39660 , m_Off1433_g39660 , m_Active1433_g39660 , m_ActiveInverted1433_g39660 );
				
				float3 Albedo = localfloat4switch1380_g39660.xyz;
				float3 Normal = localfloat3switch1416_g39660;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = localfloatswitch1436_g39660;
				float Smoothness = localfloatswitch1433_g39660;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult1344_g39660 = (float2(_Horizontalwear_TilingX , _Horizontalwear_TilingY));
				float2 appendResult1343_g39660 = (float2(_Horizontalwear_OffsetX , _Horizontalwear_OffsetY));
				float2 texCoord1342_g39660 = IN.ase_texcoord4.xy * appendResult1344_g39660 + appendResult1343_g39660;
				float4 tex2DNode1327_g39660 = SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMap, sampler_trilinear_repeat, texCoord1342_g39660 );
				float4 temp_output_12_0_g39663 = ( float4( (_Horizontalwear_Tint).rgb , 0.0 ) * tex2DNode1327_g39660 );
				float3 desaturateInitialColor10_g39663 = temp_output_12_0_g39663.xyz;
				float desaturateDot10_g39663 = dot( desaturateInitialColor10_g39663, float3( 0.299, 0.587, 0.114 ));
				...
				int _Horizontalwear_Mode1003_g39660 = _Horizontalwear_Mode;
				int m_switch1476_g39660 = _Horizontalwear_Mode1003_g39660;
				float2 texCoord794_g39660 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39683 = cos( radians( _Horizontalwear_Rotation ) );
				float sin1_g39683 = sin( radians( _Horizontalwear_Rotation ) );
				float2 rotator1_g39683 = mul( texCoord794_g39660 - float2( 0.5,0.5 ) , float2x2( cos1_g39683 , -sin1_g39683 , sin1_g39683 , cos1_g39683 )) + float2( 0.5,0.5 );
				float2 appendResult811_g39660 = (float2(_Horizontalwear_TilingXMask , _Horizontalwear_TilingYMask));
				...
				float4 Vect_0019_g39690 = _Vec;
				float2 _SmoothHorizontal = float2(0,0.5);
				float3 temp_output_40_0_g39690 = abs( ase_worldNormal );
				float WN_HORIZONTAL141_g39690 = ( ( temp_output_40_0_g39690 * temp_output_40_0_g39690 ).y + 0.07 );
				float smoothstepResult205_g39690 = smoothstep( _SmoothHorizontal.x , _SmoothHorizontal.y , ( ( 1.0 - WN_HORIZONTAL141_g39690 ) + -0.1 ));
				float4 lerpResult200_g39690 = lerp( VECTOR_IN212_g39690 , Vect_0019_g39690 , smoothstepResult205_g39690);
				float4 MASK_HORIZONTAL204_g39690 = lerpResult200_g39690;
				...
				float2 appendResult1384_g39660 = (float2(_Verticalwear_TilingX , _Verticalwear_TilingY));
				float2 appendResult1386_g39660 = (float2(_Verticalwear_OffsetX , _Verticalwear_OffsetY));
				float2 texCoord1388_g39660 = IN.ase_texcoord4.xy * appendResult1384_g39660 + appendResult1386_g39660;
				float4 tex2DNode1397_g39660 = SAMPLE_TEXTURE2D( _Verticalwear_GrungeMap, sampler_trilinear_repeat, texCoord1388_g39660 );
				float4 temp_output_12_0_g39675 = ( float4( (_Verticalwear_Tint).rgb , 0.0 ) * tex2DNode1397_g39660 );
				float3 desaturateInitialColor10_g39675 = temp_output_12_0_g39675.xyz;
				float desaturateDot10_g39675 = dot( desaturateInitialColor10_g39675, float3( 0.299, 0.587, 0.114 ));
				...
				int _Verticalwear_Mode1004_g39660 = _Verticalwear_Mode;
				int m_switch1400_g39660 = _Verticalwear_Mode1004_g39660;
				float2 texCoord1584_g39660 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39677 = cos( radians( _Verticalwear_Rotation ) );
				float sin1_g39677 = sin( radians( _Verticalwear_Rotation ) );
				float2 rotator1_g39677 = mul( texCoord1584_g39660 - float2( 0.5,0.5 ) , float2x2( cos1_g39677 , -sin1_g39677 , sin1_g39677 , cos1_g39677 )) + float2( 0.5,0.5 );
				float2 appendResult41_g39660 = (float2(_Verticalwear_TilingXMask , _Verticalwear_TilingYMask));
				...
				float4 localfloat4switch1400_g39660 = float4switch1400_g39660( m_switch1400_g39660 , m_Off1400_g39660 , m_Active1400_g39660 , m_ActiveInverted1400_g39660 );
				float4 temp_output_44_0_g39661 = localfloat4switch1400_g39660;
				float3 temp_output_40_0_g39661 = abs( ase_worldNormal );
				float WN_HORIZONTAL141_g39661 = ( ( temp_output_40_0_g39661 * temp_output_40_0_g39661 ).y + 0.07 );
				float4 lerpResult2_g39661 = lerp( temp_output_44_0_g39661 , _Vec , WN_HORIZONTAL141_g39661);
				float4 VECTOR_IN_MASKED112_g39661 = lerpResult2_g39661;
				float4 Vect_0019_g39661 = _Vec;
				float3 break349_g39661 = ase_worldNormal;
				float WN_NY173_g39661 = break349_g39661.y;
				float WN_NZ184_g39661 = break349_g39661.z;
				float WN_NX186_g39661 = break349_g39661.x;
				float temp_output_175_0_g39661 = ( -WN_NY173_g39661 + WN_NZ184_g39661 + -WN_NX186_g39661 );
				...
				float2 appendResult1393_g39660 = (float2(_Curvaturewear_TilingX , _Curvaturewear_TilingY));
				float2 appendResult1390_g39660 = (float2(_Curvaturewear_OffsetX , _Curvaturewear_OffsetY));
				float2 texCoord1389_g39660 = IN.ase_texcoord4.xy * appendResult1393_g39660 + appendResult1390_g39660;
				float4 tex2DNode1396_g39660 = SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMap, sampler_trilinear_repeat, texCoord1389_g39660 );
				float4 temp_output_12_0_g39667 = ( float4( (_Curvaturewear_Tint).rgb , 0.0 ) * tex2DNode1396_g39660 );
				float3 desaturateInitialColor10_g39667 = temp_output_12_0_g39667.xyz;
				float desaturateDot10_g39667 = dot( desaturateInitialColor10_g39667, float3( 0.299, 0.587, 0.114 ));
				...
				int _Curvaturewear_Mode398_g39660 = _Curvaturewear_Mode;
				int m_switch1491_g39660 = _Curvaturewear_Mode398_g39660;
				float2 texCoord28_g39660 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39692 = cos( radians( _Curvaturewear_Rotation ) );
				float sin1_g39692 = sin( radians( _Curvaturewear_Rotation ) );
				float2 rotator1_g39692 = mul( texCoord28_g39660 - float2( 0.5,0.5 ) , float2x2( cos1_g39692 , -sin1_g39692 , sin1_g39692 , cos1_g39692 )) + float2( 0.5,0.5 );
				float2 appendResult38_g39660 = (float2(_Curvaturewear_TilingXMask , _Curvaturewear_TilingYMask));
				...
				float4 localfloat4switch1491_g39660 = float4switch1491_g39660( m_switch1491_g39660 , m_Off1491_g39660 , m_Active1491_g39660 , m_ActiveInverted1491_g39660 );
				float4 temp_output_44_0_g39669 = localfloat4switch1491_g39660;
				float3 temp_output_40_0_g39669 = abs( ase_worldNormal );
				float WN_HORIZONTAL141_g39669 = ( ( temp_output_40_0_g39669 * temp_output_40_0_g39669 ).y + 0.07 );
				float4 lerpResult2_g39669 = lerp( temp_output_44_0_g39669 , _Vec , WN_HORIZONTAL141_g39669);
				float4 VECTOR_IN_MASKED112_g39669 = lerpResult2_g39669;
				float4 Vect_0019_g39669 = _Vec;
...
/*ASEBEGIN
Version=18913
4;29.33333;1436.667;767.6667;-535.9601;1227.616;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;290;1375.96,-874.2607;Inherit;False;355.5028;183.4201;DEBUG SETTINGS ;3;353;293;291;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;390;1381.371,-402.9673;Inherit;False;325.6667;115;DESF Common ASE Compile Shaders;1;391;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;398;1069.043,-1001.283;Inherit;False;271;139;_RECEIVE_SHADOWS_OFF;1;399;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;395;589.2099,-681.033;Inherit;False;DESF Core Surface;4;;38079;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,1,1432,1,1433,1,1434,1,1491,0,1284,2,1446,0,307,0,312,0,1318,0,249,0,1319,0,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.RangedFloatNode;353;1393.431,-763.1531;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;14;0;Create;True;1;;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;291;1392.189,-834.5454;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;393;1004.359,-679.5361;Inherit;False;DESF Module Grunge;67;;39660;b0925d725c9bfd049b8ad9f4b41a5bd0;3,1487,0,1466,0,1473,0;4;6;FLOAT4;0,0,0,0;False;8;FLOAT3;0,0,0;False;977;FLOAT4;0,0,0,0;False;989;FLOAT4;0,0,0,0;False;4;FLOAT4;0;FLOAT3;9;FLOAT;991;FLOAT;990
Node;AmplifyShaderEditor.IntNode;379;1398.669,-959.5179;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;391;1392.371,-363.9673;Inherit;False;DESF Common ASE Compile Shaders;-1;;39659;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;293;1576.695,-834.256;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.StaticSwitch;399;1086.043,-965.2832;Inherit;False;Property;_RECEIVE_SHADOWS_OFF;Receive Shadows;2;0;Create;False;0;0;0;True;0;False;0;0;0;True;_RECEIVE_SHADOWS_OFF;Toggle;2;Key0;Key1;Fetch;True;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;295;1380.783,-994.665;Inherit;False;172;115;GLOBAL SETTINGS ;0;;0,0,0,1;0;0
...
ASEEND*/
//CHKSM=5744AE8B1C418AFB6B6477176ED5735BDADB937A