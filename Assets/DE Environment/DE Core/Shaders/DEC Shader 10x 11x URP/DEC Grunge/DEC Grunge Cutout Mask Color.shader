...
Shader "DEC/Grunge/Grunge Cutout Mask Color"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 float4switch1506_g39881( int m_switch, float4 m_MapGrunge, float4 m_MapAlbedo )
			{
				if(m_switch ==0)
					return m_MapGrunge;
				else if(m_switch ==1)
			...
			float4 float4switch1512_g39881( int m_switch, float4 m_MapGrunge, float4 m_MapAlbedo )
			{
				if(m_switch ==0)
					return m_MapGrunge;
				else if(m_switch ==1)
			...
			float4 float4switch1516_g39881( int m_switch, float4 m_MapGrunge, float4 m_MapAlbedo )
			{
				if(m_switch ==0)
					return m_MapGrunge;
				else if(m_switch ==1)
			...
			float floatswitch1287_g37963( int m_switch, float m_Off, float m_Active )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 appendResult168_g37963 = (float2(_TilingX , _TilingY));
				float2 appendResult167_g37963 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39802 = IN.ase_texcoord8.xy * appendResult168_g37963 + appendResult167_g37963;
				float2 appendResult6_g39802 = (float2(texCoord2_g39802.x , texCoord2_g39802.y));
				float2 OUT_UV213_g37963 = appendResult6_g39802;
				float2 UV40_g39808 = OUT_UV213_g37963;
				float4 tex2DNode63_g39808 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39808 );
				float4 ALBEDO_RGBA1381_g37963 = tex2DNode63_g39808;
				float4 ALBEDO151_g39811 = ALBEDO_RGBA1381_g37963;
				...
				float4 temp_output_3_0_g37963 = ( localfloat4switch143_g39811 * float4( (ALBEDO_RGBA1381_g37963).rgb , 0.0 ) * _Brightness );
				float4 temp_output_6_0_g39881 = ( temp_output_3_0_g37963 + float4(0,0,0,0) );
				...
				float4 break91_g39907 = _Horizontalwear_MaskingColor;
				float3 appendResult87_g39907 = (float3(break91_g39907.r , break91_g39907.g , break91_g39907.b));
				int m_switch1506_g39881 = _Horizontalwear_MaskingSource;
				float4 _Horizontalwear_GrungeMap1508_g39881 = tex2DNode1327_g39881;
				float4 m_MapGrunge1506_g39881 = _Horizontalwear_GrungeMap1508_g39881;
				float4 ALBEDO_IN1447_g39881 = temp_output_6_0_g39881;
				float4 m_MapAlbedo1506_g39881 = ALBEDO_IN1447_g39881;
				float4 localfloat4switch1506_g39881 = float4switch1506_g39881( m_switch1506_g39881 , m_MapGrunge1506_g39881 , m_MapAlbedo1506_g39881 );
				float4 break89_g39907 = localfloat4switch1506_g39881;
				float3 appendResult88_g39907 = (float3(break89_g39907.x , break89_g39907.y , break89_g39907.z));
				float4 temp_cast_18 = (saturate( ( 1.0 - ( ( distance( appendResult87_g39907 , appendResult88_g39907 ) - _Horizontalwear_MaskingColorRange ) / max( _Horizontalwear_MaskingColorFuzziness , 1E-05 ) ) ) )).xxxx;
				float4 m_Off1476_g39881 = temp_cast_18;
				float4 temp_cast_19 = (saturate( ( 1.0 - ( ( distance( appendResult87_g39907 , appendResult88_g39907 ) - _Horizontalwear_MaskingColorRange ) / max( _Horizontalwear_MaskingColorFuzziness , 1E-05 ) ) ) )).xxxx;
				float4 m_Active1476_g39881 = temp_cast_19;
				float4 temp_cast_20 = (saturate( ( 1.0 - saturate( ( 1.0 - ( ( distance( appendResult87_g39907 , appendResult88_g39907 ) - _Horizontalwear_MaskingColorRange ) / max( _Horizontalwear_MaskingColorFuzziness , 1E-05 ) ) ) ) ) )).xxxx;
				float4 m_ActiveInverted1476_g39881 = temp_cast_20;
				...
				float4 smoothstepResult75_g39911 = smoothstep( temp_cast_15 , temp_cast_16 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_HORIZONTAL204_g39911 ) - temp_cast_21) * (temp_cast_22 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_21)));
				...
				float4 break91_g39902 = _Verticalwear_MaskingColor;
				float3 appendResult87_g39902 = (float3(break91_g39902.r , break91_g39902.g , break91_g39902.b));
				int m_switch1512_g39881 = _Verticalwear_MaskingSource;
				float4 _Verticalwear_GrungeMap1509_g39881 = tex2DNode1397_g39881;
				float4 m_MapGrunge1512_g39881 = _Verticalwear_GrungeMap1509_g39881;
				float4 m_MapAlbedo1512_g39881 = ALBEDO_IN1447_g39881;
				float4 localfloat4switch1512_g39881 = float4switch1512_g39881( m_switch1512_g39881 , m_MapGrunge1512_g39881 , m_MapAlbedo1512_g39881 );
				float4 break89_g39902 = localfloat4switch1512_g39881;
				float3 appendResult88_g39902 = (float3(break89_g39902.x , break89_g39902.y , break89_g39902.z));
				float4 temp_cast_30 = (saturate( ( 1.0 - ( ( distance( appendResult87_g39902 , appendResult88_g39902 ) - _Verticalwear_MaskingColorRange ) / max( _Verticalwear_MaskingColorFuzziness , 1E-05 ) ) ) )).xxxx;
				float4 m_Off1400_g39881 = temp_cast_30;
				float4 temp_cast_31 = (saturate( ( 1.0 - ( ( distance( appendResult87_g39902 , appendResult88_g39902 ) - _Verticalwear_MaskingColorRange ) / max( _Verticalwear_MaskingColorFuzziness , 1E-05 ) ) ) )).xxxx;
				float4 m_Active1400_g39881 = temp_cast_31;
				float4 temp_cast_32 = (saturate( ( 1.0 - saturate( ( 1.0 - ( ( distance( appendResult87_g39902 , appendResult88_g39902 ) - _Verticalwear_MaskingColorRange ) / max( _Verticalwear_MaskingColorFuzziness , 1E-05 ) ) ) ) ) )).xxxx;
				float4 m_ActiveInverted1400_g39881 = temp_cast_32;
				...
				float4 smoothstepResult75_g39882 = smoothstep( temp_cast_27 , temp_cast_28 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_SIDE163_g39882 ) - temp_cast_33) * (temp_cast_34 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_33)));
				...
				float4 break91_g39909 = _Curvaturewear_MaskingColor;
				float3 appendResult87_g39909 = (float3(break91_g39909.r , break91_g39909.g , break91_g39909.b));
				int m_switch1516_g39881 = _Curvaturewear_MaskingSource;
				float4 _Curvaturewear_GrungeMap1510_g39881 = tex2DNode1396_g39881;
				float4 m_MapGrunge1516_g39881 = _Curvaturewear_GrungeMap1510_g39881;
				float4 m_MapAlbedo1516_g39881 = ALBEDO_IN1447_g39881;
				float4 localfloat4switch1516_g39881 = float4switch1516_g39881( m_switch1516_g39881 , m_MapGrunge1516_g39881 , m_MapAlbedo1516_g39881 );
				float4 break89_g39909 = localfloat4switch1516_g39881;
				float3 appendResult88_g39909 = (float3(break89_g39909.x , break89_g39909.y , break89_g39909.z));
				float4 temp_cast_42 = (saturate( ( 1.0 - ( ( distance( appendResult87_g39909 , appendResult88_g39909 ) - _Curvaturewear_MaskingColorRange ) / max( _Curvaturewear_MaskingColorFuzziness , 1E-05 ) ) ) )).xxxx;
				float4 m_Off1491_g39881 = temp_cast_42;
				float4 temp_cast_43 = (saturate( ( 1.0 - ( ( distance( appendResult87_g39909 , appendResult88_g39909 ) - _Curvaturewear_MaskingColorRange ) / max( _Curvaturewear_MaskingColorFuzziness , 1E-05 ) ) ) )).xxxx;
				float4 m_Active1491_g39881 = temp_cast_43;
				float4 temp_cast_44 = (saturate( ( 1.0 - saturate( ( 1.0 - ( ( distance( appendResult87_g39909 , appendResult88_g39909 ) - _Curvaturewear_MaskingColorRange ) / max( _Curvaturewear_MaskingColorFuzziness , 1E-05 ) ) ) ) ) )).xxxx;
				float4 m_ActiveInverted1491_g39881 = temp_cast_44;
				...
				float3 break24_g39890 = ( temp_output_40_0_g39890 - temp_cast_45 );
				...
				float4 smoothstepResult75_g39890 = smoothstep( temp_cast_39 , temp_cast_40 , (float4( 0,0,0,0 ) + (( 1.0 - ( MASK_VERTICAL_X159_g39890 + MASK_VERTICAL_Y157_g39890 + MASK_VERTICAL_Z155_g39890 ) ) - temp_cast_46) * (temp_cast_47 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_46)));
				...
				float4 NORMAL_RGB1382_g37963 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_output_1_0_g39806 = NORMAL_RGB1382_g37963;
				...
				float3 temp_output_1519_59_g37963 = unpack52_g39806;
				float3 NORMAL_IN42_g39824 = temp_output_1519_59_g37963;
				...
				float3 temp_output_1610_30_g37963 = localfloat3switch37_g39824;
				float3 NORMAL_OUT1491_g37963 = temp_output_1610_30_g37963;
				float3 temp_output_16_0_g39796 = NORMAL_OUT1491_g37963;
				...
				float3 ADDITIONAL_LIGHT1212_g37963 = localAdditionalLightsFlatMask63_g39796;
				float3 temp_output_8_0_g39881 = ( switchResult58_g39824 + ADDITIONAL_LIGHT1212_g37963 );
				...
				float4 MASK_B1377_g37963 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_output_977_0_g39881 = ( _MetallicStrength * MASK_B1377_g37963 );
				float m_Off1434_g39881 = temp_output_977_0_g39881.x;
				float FINAL_MASKMETALLIC_HORIZONTAL1026_g39881 = _Horizontalwear_Metallic;
				float4 temp_cast_55 = (FINAL_MASKMETALLIC_HORIZONTAL1026_g39881).xxxx;
				float4 lerpResult1439_g39881 = lerp( temp_output_977_0_g39881 , temp_cast_55 , MASK_HORIZONTAL808_g39881);
				...
				float4 lerpResult1553_g39881 = lerp( METALLIC_IN1555_g39881 , temp_cast_58 , _Curvaturewear_BlendMix);
				float4 FINAL_MASKMETALLIC_CURVATURE1022_g39881 = lerpResult1553_g39881;
				float4 temp_cast_59 = (localfloatswitch1435_g39881).xxxx;
				float4 lerpResult1437_g39881 = lerp( FINAL_MASKMETALLIC_CURVATURE1022_g39881 , temp_cast_59 , MASK_CURVATURE401_g39881);
				...
				float3 tanNormal1608_g37963 = NORMAL_OUT1491_g37963;
				float3 worldNormal1608_g37963 = normalize( float3(dot(tanToWorld0,tanNormal1608_g37963), dot(tanToWorld1,tanNormal1608_g37963), dot(tanToWorld2,tanNormal1608_g37963)) );
				float3 temp_output_4_0_g39758 = worldNormal1608_g37963;
				...
				float ALBEDO_R172_g37963 = tex2DNode63_g39808.r;
				float4 temp_cast_62 = (ALBEDO_R172_g37963).xxxx;
				...
				float ALBEDO_A926_g37963 = tex2DNode63_g39808.a;
				int m_switch1287_g37963 = _GlancingClipMode;
				float m_Off1287_g37963 = 1.0;
				float3 normalizeResult1294_g37963 = normalize( cross( ddx( WorldPosition ) , ddy( WorldPosition ) ) );
				float dotResult1301_g37963 = dot( WorldViewDirection , normalizeResult1294_g37963 );
				float temp_output_1321_0_g37963 = ( 1.0 - abs( dotResult1301_g37963 ) );
				float m_Active1287_g37963 = ( 1.0 - ( temp_output_1321_0_g37963 * temp_output_1321_0_g37963 ) );
				float localfloatswitch1287_g37963 = floatswitch1287_g37963( m_switch1287_g37963 , m_Off1287_g37963 , m_Active1287_g37963 );
				float OPACITY_OUTMASK1277_g37963 = localfloatswitch1287_g37963;
				float CLIP_OPACITY200_g37963 = ( ALBEDO_A926_g37963 * OPACITY_OUTMASK1277_g37963 );
				float4 temp_cast_63 = (CLIP_OPACITY200_g37963).xxxx;
				...
				float4 MASK_G158_g37963 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_output_83_0_g39758 = MASK_G158_g37963;
				...
				float4 temp_output_1324_33_g37963 = localfloat4switch188_g39758;
				float4 color1225_g37963 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 MASK_R1378_g37963 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_cast_65 = (IN.ase_color.a).xxxx;
				float4 lerpResult28_g37963 = lerp( MASK_R1378_g37963 , temp_cast_65 , (float)_OcclusionSourceMode);
				float4 lerpResult7_g37963 = lerp( color1225_g37963 , lerpResult28_g37963 , _OcclusionStrengthAO);
				float4 temp_output_989_0_g39881 = ( temp_output_1324_33_g37963 * lerpResult7_g37963 );
				...
				float4 temp_cast_69 = (FINAL_MASKSMOOTHNESS_HORIZONTAL1025_g39881).xxxx;
				float4 lerpResult1030_g39881 = lerp( temp_output_989_0_g39881 , temp_cast_69 , MASK_HORIZONTAL808_g39881);
				...
				float4 lerpResult1552_g39881 = lerp( SMOOTHNESS_IN1554_g39881 , temp_cast_72 , _Curvaturewear_BlendMix);
				float4 FINAL_MASKSMOOTHNESS_CURVATURE1021_g39881 = lerpResult1552_g39881;
				float4 temp_cast_73 = (localfloatswitch1432_g39881).xxxx;
				float4 lerpResult1031_g39881 = lerp( FINAL_MASKSMOOTHNESS_CURVATURE1021_g39881 , temp_cast_73 , MASK_CURVATURE401_g39881);
				...
				float AlphaCutoffBias1289_g37963 = _AlphaCutoffBias;
				...
				float Occlusion = saturate( lerpResult7_g37963 ).r;
				float Alpha = ( ALBEDO_A926_g37963 * OPACITY_OUTMASK1277_g37963 );
				float AlphaClipThreshold = AlphaCutoffBias1289_g37963;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult168_g37963 = (float2(_TilingX , _TilingY));
				float2 appendResult167_g37963 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39802 = IN.ase_texcoord2.xy * appendResult168_g37963 + appendResult167_g37963;
				float2 appendResult6_g39802 = (float2(texCoord2_g39802.x , texCoord2_g39802.y));
				float2 OUT_UV213_g37963 = appendResult6_g39802;
				float2 UV40_g39808 = OUT_UV213_g37963;
				float4 tex2DNode63_g39808 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39808 );
				...
				float3 normalizeResult1294_g37963 = normalize( cross( ddx( WorldPosition ) , ddy( WorldPosition ) ) );
				float dotResult1301_g37963 = dot( ase_worldViewDir , normalizeResult1294_g37963 );
				float temp_output_1321_0_g37963 = ( 1.0 - abs( dotResult1301_g37963 ) );
				float m_Active1287_g37963 = ( 1.0 - ( temp_output_1321_0_g37963 * temp_output_1321_0_g37963 ) );
				float localfloatswitch1287_g37963 = floatswitch1287_g37963( m_switch1287_g37963 , m_Off1287_g37963 , m_Active1287_g37963 );
				float OPACITY_OUTMASK1277_g37963 = localfloatswitch1287_g37963;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult168_g37963 = (float2(_TilingX , _TilingY));
				float2 appendResult167_g37963 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39802 = IN.ase_texcoord4.xy * appendResult168_g37963 + appendResult167_g37963;
				float2 appendResult6_g39802 = (float2(texCoord2_g39802.x , texCoord2_g39802.y));
				float2 OUT_UV213_g37963 = appendResult6_g39802;
				float2 UV40_g39808 = OUT_UV213_g37963;
				float4 tex2DNode63_g39808 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39808 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult168_g37963 = (float2(_TilingX , _TilingY));
				float2 appendResult167_g37963 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39802 = IN.ase_texcoord3.xy * appendResult168_g37963 + appendResult167_g37963;
				float2 appendResult6_g39802 = (float2(texCoord2_g39802.x , texCoord2_g39802.y));
				float2 OUT_UV213_g37963 = appendResult6_g39802;
				float2 UV40_g39808 = OUT_UV213_g37963;
				float4 tex2DNode63_g39808 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39808 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436.667;767.6667;4789.89;4255.792;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;2819;-3945.129,-3965.892;Inherit;False;169.5;117.8;GLOBAL SETTINGS ;1;2848;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;2820;-3949.45,-3844.181;Inherit;False;383.5028;189.4201;DEBUG SETTINGS ;4;2849;2760;202;2758;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;2880;-4749.651,-3643.89;Inherit;False;DESF Core Cutout;5;;37963;e0cdd7758f4404849b063afff4596424;26,1217,2,1311,2,1296,2,1156,2,1141,2,442,2,1509,1,1556,1,1557,1,1552,1,1309,1,1308,1,1333,0,1348,0,1596,0,1368,2,1569,0,96,0,1229,0,1236,0,830,0,1415,0,1399,0,1564,0,1566,0,1565,0;2;1234;FLOAT3;0,0,0;False;1274;FLOAT4;0,0,0,0;False;14;FLOAT4;38;FLOAT3;35;FLOAT3;1586;COLOR;37;FLOAT4;33;COLOR;34;FLOAT;441;FLOAT;46;FLOAT;814;FLOAT;552;FLOAT4;656;FLOAT4;657;FLOAT4;655;FLOAT3;1235
Node;AmplifyShaderEditor.CommentaryNode;2875;-3949.968,-3332.157;Inherit;False;329.6667;113;DESF Common ASE Compile Shaders;1;2876;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;2883;-4231.806,-3966.459;Inherit;False;271;139;_RECEIVE_SHADOWS_OFF;1;2884;;0,0,0,1;0;0
Node;AmplifyShaderEditor.StaticSwitch;2884;-4223.806,-3927.459;Inherit;False;Property;_RECEIVE_SHADOWS_OFF;Receive Shadows;3;0;Create;False;0;0;0;True;0;False;0;0;0;True;_RECEIVE_SHADOWS_OFF;Toggle;2;Key0;Key1;Fetch;True;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;202;-3941.471,-3810.078;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;64;1;[HideInInspector];Create;True;1;;0;0;True;0;False;0.5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2849;-3755.449,-3736.498;Inherit;False;Property;_AlphatoCoverage;Alpha to Coverage;2;1;[Enum];Create;False;1;;1;Option1;0;1;Off,0,On,1;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;2760;-3755.312,-3810.885;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;2848;-3929.649,-3927.208;Inherit;False;Property;_CullMode;Cull Mode;4;2;[Header];[Enum];Create;True;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;2878;-4327.298,-3640.601;Inherit;False;DESF Module Grunge;120;;39881;b0925d725c9bfd049b8ad9f4b41a5bd0;3,1487,1,1466,1,1473,1;4;6;FLOAT4;0,0,0,0;False;8;FLOAT3;0,0,0;False;977;FLOAT4;0,0,0,0;False;989;FLOAT4;0,0,0,0;False;4;FLOAT4;0;FLOAT3;9;FLOAT;991;FLOAT;990
Node;AmplifyShaderEditor.FunctionNode;2876;-3931.968,-3294.157;Inherit;False;DESF Common ASE Compile Shaders;-1;;39880;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;2758;-3940.076,-3734.627;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
...
ASEEND*/
//CHKSM=3F5DA9917DD2979CCDA3CB9EF6A33EC04AD5B55B