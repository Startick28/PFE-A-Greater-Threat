	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord2_g39586 = IN.ase_texcoord8.xy * appendResult150_g38539 + appendResult151_g38539;
				...
				float4 ALBEDO151_g39556 = OUT_ALBEDO_RGBA1177_g38539;
				...
				float4 temp_output_7_0_g38539 = ( localfloat4switch143_g39556 * float4( (OUT_ALBEDO_RGBA1177_g38539).rgb , 0.0 ) * _Brightness );
				float4 temp_output_39_0_g39592 = ( temp_output_7_0_g38539 + float4(0,0,0,0) );
				...
				float2 texCoord67_g39592 = IN.ase_texcoord8.xy * appendResult132_g39592 + appendResult114_g39592;
				float4 tex2DNode45_g39592 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g39592 );
				...
				float2 texCoord220_g39592 = IN.ase_texcoord8.xy * appendResult219_g39592 + appendResult206_g39592;
				float temp_output_15_0_g39596 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g39592 ).r );
				...
				float m_Red319_g39592 = IN.ase_color.r;
				float m_Green319_g39592 = IN.ase_color.g;
				float m_Blue319_g39592 = IN.ase_color.b;
				...
				float3 NORMAL_OUT314_g38539 = temp_output_1478_59_g38539;
				...
				float3 temp_output_38_0_g39592 = ( temp_output_1478_59_g38539 + ADDITIONAL_LIGHT1342_g38539 );
				...
				float4 temp_output_1_0_g39597 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat, texCoord67_g39592 );
				float temp_output_8_0_g39597 = _DetailNormalMapScale;
				float3 unpack52_g39597 = UnpackNormalScale( temp_output_1_0_g39597, temp_output_8_0_g39597 );
				unpack52_g39597.z = lerp( 1, unpack52_g39597.z, saturate(temp_output_8_0_g39597) );
				float3 NORMAL_OUT199_g39592 = unpack52_g39597;
				...
				float3 NORMAL_WORLD_OUT164_g38539 = temp_output_1478_59_g38539;
				...
				float4 temp_cast_21 = (ALBEDO_R169_g38539).xxxx;
				...
				float4 lerpResult11_g38539 = lerp( _MASK_R1439_g38539 , temp_cast_23 , (float)_OcclusionSourceMode);
				float4 lerpResult14_g38539 = lerp( color301_g38539 , lerpResult11_g38539 , _OcclusionStrengthAO);
				
				float3 Albedo = localfloat4switch125_g39592.xyz;
				float3 Normal = localfloat3switch127_g39592;
				float3 Emission = 0;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord4.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38539 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38539;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
				...
				float2 appendResult132_g39592 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g39592 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g39592 = IN.ase_texcoord4.xy * appendResult132_g39592 + appendResult114_g39592;
				float4 tex2DNode45_g39592 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g39592 );
				float4 ALBEDO_OUT255_g39592 = ( _ColorDetail * tex2DNode45_g39592 * _Brightness );
				float4 m_Off226_g39592 = ALBEDO_OUT255_g39592;
				float2 appendResult219_g39592 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g39592 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g39592 = IN.ase_texcoord4.xy * appendResult219_g39592 + appendResult206_g39592;
				float temp_output_15_0_g39596 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g39592 ).r );
				float temp_output_26_0_g39596 = _Detail_BlendAmountMask;
				float temp_output_24_0_g39596 = _Detail_BlendHardnessMask;
				float saferPower2_g39596 = max( max( saturate( (0.0 + (temp_output_15_0_g39596 - ( 1.0 - temp_output_26_0_g39596 )) * (temp_output_24_0_g39596 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g39596 ))) ) , 0.0 ) , 0.0001 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436.667;767.6667;-533.075;1320.143;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;388;1378.537,-406.1953;Inherit;False;317.6667;122;DESF Common ASE Compile Shaders;1;389;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;290;1382.96,-883.2607;Inherit;False;345.5028;190.4201;DEBUG SETTINGS ;3;293;353;291;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;295;1387.783,-1007.665;Inherit;False;175;115;GLOBAL SETTINGS ;1;379;;0.09433961,0.09433961,0.09433961,1;0;0
Node;AmplifyShaderEditor.FunctionNode;390;701.3248,-683.5601;Inherit;False;DESF Core Surface;4;;38539;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,1,1432,1,1433,1,1434,1,1491,0,1284,2,1446,0,307,0,312,0,1318,0,249,0,1319,0,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.CommentaryNode;393;1101.158,-1009.81;Inherit;False;271;139;_RECEIVE_SHADOWS_OFF;1;394;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;387;1100.067,-680.7551;Inherit;False;DESF Module Detail;67;;39592;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.FunctionNode;389;1388.537,-365.1953;Inherit;False;DESF Common ASE Compile Shaders;-1;;39591;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;353;1396.431,-770.1531;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;14;0;Create;True;1;;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;293;1574.395,-840.7571;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;291;1392.189,-841.5454;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
Node;AmplifyShaderEditor.StaticSwitch;394;1109.158,-970.8103;Inherit;False;Property;_RECEIVE_SHADOWS_OFF;Receive Shadows;2;0;Create;False;0;0;0;True;0;False;0;0;0;True;_RECEIVE_SHADOWS_OFF;Toggle;2;Key0;Key1;Fetch;True;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;379;1407.669,-972.5179;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
...
ASEEND*/
//CHKSM=778409563023A146EF0A425E11ABE9625F9FFB1A