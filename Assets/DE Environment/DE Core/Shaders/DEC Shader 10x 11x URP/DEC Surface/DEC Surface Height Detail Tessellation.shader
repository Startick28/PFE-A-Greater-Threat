...
Shader "DEC/Surface/Surface Height Detail Tessellation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 float3switch1310_g38539( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveReconstructed )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch1387_g38539( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveReconstructed )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord2_g39586 = v.texcoord.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38539 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38539;
				float4 OUT_DISPLAC1180_g38539 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g39580, 0.0 );
				float4 temp_output_60_0_g39558 = OUT_DISPLAC1180_g38539;
				...
				#endif
				float3 vertexValue = ( temp_output_309_0_g38539 + localfloat3switch74_g39558 );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord7.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38539 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38539;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
				float4 OUT_ALBEDO_RGBA1177_g38539 = tex2DNode63_g39580;
				float3 temp_output_7_0_g38539 = ( (_Color).rgb * (OUT_ALBEDO_RGBA1177_g38539).rgb * _Brightness );
				float4 temp_output_39_0_g39599 = ( float4( temp_output_7_0_g38539 , 0.0 ) + float4(0,0,0,0) );
				...
				int _Displacement_Mode1309_g38539 = _Displacement_Mode;
				int m_switch1310_g38539 = _Displacement_Mode1309_g38539;
				float4 OUT_NORMAL1178_g38539 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_1_0_g39549 = OUT_NORMAL1178_g38539;
				...
				float3 temp_output_1478_59_g38539 = unpack52_g39549;
				...
				float temp_output_29_0_g39545 = temp_output_1334_0_g38539;
				float Strength31_g39545 = temp_output_29_0_g39545;
				float localCalculateUVsSmooth19_g39545 = ( 0.0 );
				float2 temp_output_96_0_g39545 = OUT_UV431_g38539;
				...
				float3 m_ActiveReconstructed1310_g38539 = localCombineSamplesSmooth31_g39545;
				float3 localfloat3switch1310_g38539 = float3switch1310_g38539( m_switch1310_g38539 , m_Off1310_g38539 , m_Active1310_g38539 , m_ActiveReconstructed1310_g38539 );
				float3 NORMAL_OUT314_g38539 = localfloat3switch1310_g38539;
				float3 temp_output_16_0_g39547 = NORMAL_OUT314_g38539;
				...
				float3 ADDITIONAL_LIGHT1342_g38539 = localAdditionalLightsFlatMask63_g39547;
				float3 temp_output_38_0_g39599 = ( localfloat3switch1310_g38539 + ADDITIONAL_LIGHT1342_g38539 );
				...
				float4 _MASK_B1440_g38539 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat, UV40_g39580 );
				...
				int m_switch1387_g38539 = _Displacement_Mode1309_g38539;
				...
				float3 temp_output_1478_66_g38539 = worldNormal67_g39549;
				...
				float3 m_ActiveReconstructed1387_g38539 = tangentToWorldDir104_g39545;
				float3 localfloat3switch1387_g38539 = float3switch1387_g38539( m_switch1387_g38539 , m_Off1387_g38539 , m_Active1387_g38539 , m_ActiveReconstructed1387_g38539 );
				float3 NORMAL_WORLD_OUT164_g38539 = localfloat3switch1387_g38539;
				float3 temp_output_4_0_g39551 = NORMAL_WORLD_OUT164_g38539;
				...
				float4 temp_cast_11 = (ALBEDO_R169_g38539).xxxx;
				...
				float4 _MASK_G1438_g38539 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_83_0_g39551 = _MASK_G1438_g38539;
				...
				float4 temp_output_1267_33_g38539 = localfloat4switch99_g39551;
				float4 color301_g38539 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 _MASK_R1439_g38539 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_cast_13 = (IN.ase_color.a).xxxx;
				float4 lerpResult11_g38539 = lerp( _MASK_R1439_g38539 , temp_cast_13 , (float)_OcclusionSourceMode);
				float4 lerpResult14_g38539 = lerp( color301_g38539 , lerpResult11_g38539 , _OcclusionStrengthAO);
				
				float3 Albedo = localfloat4switch125_g39599.xyz;
				float3 Normal = localfloat3switch127_g39599;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * _MASK_B1440_g38539 ).r;
				float Smoothness = ( temp_output_1267_33_g38539 * lerpResult14_g38539 ).x;
				float Occlusion = saturate( lerpResult14_g38539 ).r;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = v.ase_texcoord.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38539 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38539;
				float4 OUT_DISPLAC1180_g38539 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g39580, 0.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord2.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38539 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38539;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436.667;767.6667;-54.16052;1280.174;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;384;1050.215,-1022.793;Inherit;False;297.1923;321.7019;Tessellation;4;388;385;387;386;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;295;1356.783,-1024.665;Inherit;False;176;119;GLOBAL SETTINGS ;1;379;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;394;1379.743,-393.798;Inherit;False;324.6667;117;DESF Common ASE Compile Shaders;1;395;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;290;1356.96,-896.2607;Inherit;False;343.5028;190.4201;DEBUG SETTINGS ;3;293;353;291;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;396;705.1121,-688.88;Inherit;False;DESF Core Surface;4;;38539;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,1,1432,1,1433,1,1434,1,1491,0,1284,0,1446,0,307,0,312,0,1318,1,249,1,1319,1,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.CommentaryNode;400;766.2439,-1023.591;Inherit;False;271;139;_RECEIVE_SHADOWS_OFF;1;401;;0,0,0,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;387;1068.714,-920.8705;Half;False;Property;_TessellationDistanceMin;Tessellation Distance Min;69;0;Create;False;1;;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;401;774.2439,-984.5913;Inherit;False;Property;_RECEIVE_SHADOWS_OFF;Receive Shadows;2;0;Create;False;0;0;0;True;0;False;0;0;0;True;_RECEIVE_SHADOWS_OFF;Toggle;2;Key0;Key1;Fetch;True;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;395;1390.743,-352.798;Inherit;False;DESF Common ASE Compile Shaders;-1;;39606;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;393;1112.659,-683.048;Inherit;False;DESF Module Detail;71;;39599;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.RangedFloatNode;388;1067.701,-781.3647;Half;False;Property;_TessellationPhong;Tessellation Phong;68;0;Create;False;1;;0;0;True;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;293;1550.295,-851.7178;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;291;1366.189,-854.5454;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;353;1370.431,-783.1531;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;14;0;Create;True;1;;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;379;1375.669,-990.5179;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;385;1069.53,-850.6912;Half;False;Property;_TessellationDistanceMax;Tessellation Distance Max ;70;0;Create;False;1;;0;0;True;0;False;5;2000;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;386;1068.215,-990.0854;Half;False;Property;_TessellationStrength;Tessellation Strength;67;0;Create;False;1;;0;0;True;1;Header(TESSELLATION URP);False;6;0.5;0.001;100;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=691BA2E3551B63A3154C3999F719D9A635AFAE6B