...
Shader "DEC/Surface/Surface Height Detail"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 float3switch1310_g38532( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveReconstructed )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch1387_g38532( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveReconstructed )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord2_g39586 = v.texcoord.xy * appendResult150_g38532 + appendResult151_g38532;
				...
				float4 OUT_DISPLAC1180_g38532 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g39580, 0.0 );
				float4 temp_output_60_0_g39558 = OUT_DISPLAC1180_g38532;
				...
				#endif
				float3 vertexValue = ( temp_output_309_0_g38532 + localfloat3switch74_g39558 );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				int _Displacement_Mode1309_g38532 = _Displacement_Mode;
				int m_switch1310_g38532 = _Displacement_Mode1309_g38532;
				...
				float temp_output_29_0_g39545 = temp_output_1334_0_g38532;
				float Strength31_g39545 = temp_output_29_0_g39545;
				float localCalculateUVsSmooth19_g39545 = ( 0.0 );
				float2 temp_output_96_0_g39545 = OUT_UV431_g38532;
				...
				float3 m_ActiveReconstructed1310_g38532 = localCombineSamplesSmooth31_g39545;
				float3 localfloat3switch1310_g38532 = float3switch1310_g38532( m_switch1310_g38532 , m_Off1310_g38532 , m_Active1310_g38532 , m_ActiveReconstructed1310_g38532 );
				float3 NORMAL_OUT314_g38532 = localfloat3switch1310_g38532;
				...
				float3 temp_output_38_0_g39599 = ( localfloat3switch1310_g38532 + ADDITIONAL_LIGHT1342_g38532 );
				...
				int m_switch1387_g38532 = _Displacement_Mode1309_g38532;
				...
				float3 temp_output_1478_66_g38532 = worldNormal67_g39549;
				...
				float3 m_ActiveReconstructed1387_g38532 = tangentToWorldDir104_g39545;
				float3 localfloat3switch1387_g38532 = float3switch1387_g38532( m_switch1387_g38532 , m_Off1387_g38532 , m_Active1387_g38532 , m_ActiveReconstructed1387_g38532 );
				float3 NORMAL_WORLD_OUT164_g38532 = localfloat3switch1387_g38532;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 appendResult150_g38532 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38532 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = v.ase_texcoord.xy * appendResult150_g38532 + appendResult151_g38532;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38532 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38532;
				float4 OUT_DISPLAC1180_g38532 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g39580, 0.0 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436.667;767.6667;-333.6061;1237.829;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;290;1375.96,-881.2607;Inherit;False;339.5028;187.4201;DEBUG SETTINGS ;3;293;353;291;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;295;1378.783,-999.665;Inherit;False;175;115;GLOBAL SETTINGS ;1;379;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;388;1375.562,-403.4117;Inherit;False;321.6667;116;DESF Common ASE Compile Shaders;1;389;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;390;704.8555,-683.246;Inherit;False;DESF Core Surface;4;;38532;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,1,1432,1,1433,1,1434,1,1491,0,1284,0,1446,0,307,0,312,0,1318,1,249,1,1319,1,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.CommentaryNode;393;1085.689,-995.4963;Inherit;False;271;139;_RECEIVE_SHADOWS_OFF;1;394;;0,0,0,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;353;1389.431,-768.1531;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;14;0;Create;True;1;;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;291;1385.189,-839.5454;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;387;1107.953,-680.5229;Inherit;False;DESF Module Detail;67;;39599;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.IntNode;379;1393.669,-964.5179;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;389;1389.562,-363.4117;Inherit;False;DESF Common ASE Compile Shaders;-1;;39598;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;394;1093.689,-956.4963;Inherit;False;Property;_RECEIVE_SHADOWS_OFF;Receive Shadows;2;0;Create;False;0;0;0;True;0;False;0;0;0;True;_RECEIVE_SHADOWS_OFF;Toggle;2;Key0;Key1;Fetch;True;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;293;1564.695,-840.718;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
...
ASEEND*/
//CHKSM=28CD22C1262854A437F1D246F3C197097308F337