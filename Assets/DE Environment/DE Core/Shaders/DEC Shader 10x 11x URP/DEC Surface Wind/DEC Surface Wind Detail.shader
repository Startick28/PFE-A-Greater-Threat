	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord67_g39592 = IN.ase_texcoord7.xy * appendResult132_g39592 + appendResult114_g39592;
				...
				float2 texCoord220_g39592 = IN.ase_texcoord7.xy * appendResult219_g39592 + appendResult206_g39592;
				...
				float3 temp_output_38_0_g39592 = ( temp_output_1478_59_g38532 + ADDITIONAL_LIGHT1342_g38532 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult132_g39592 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g39592 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g39592 = IN.ase_texcoord2.xy * appendResult132_g39592 + appendResult114_g39592;
				float4 tex2DNode45_g39592 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g39592 );
				float4 ALBEDO_OUT255_g39592 = ( _ColorDetail * tex2DNode45_g39592 * _Brightness );
				float4 m_Off226_g39592 = ALBEDO_OUT255_g39592;
				float2 appendResult219_g39592 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g39592 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g39592 = IN.ase_texcoord2.xy * appendResult219_g39592 + appendResult206_g39592;
				float temp_output_15_0_g39596 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g39592 ).r );
				float temp_output_26_0_g39596 = _Detail_BlendAmountMask;
				float temp_output_24_0_g39596 = _Detail_BlendHardnessMask;
				float saferPower2_g39596 = max( max( saturate( (0.0 + (temp_output_15_0_g39596 - ( 1.0 - temp_output_26_0_g39596 )) * (temp_output_24_0_g39596 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g39596 ))) ) , 0.0 ) , 0.0001 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436.667;767.6667;-485.1912;1268.822;1;True;False
Node;AmplifyShaderEditor.FunctionNode;387;500.3608,-683.3875;Inherit;False;DESF Module Wind;94;;3439;b135a554f7e4d0b41bba02c61b34ae74;11,938,0,2881,0,2454,0,2457,0,2432,0,2434,0,2433,0,2371,0,2752,0,2995,0,2878,0;0;2;FLOAT3;2190;FLOAT4;2970
Node;AmplifyShaderEditor.CommentaryNode;295;1380.783,-982.665;Inherit;False;174;107;GLOBAL SETTINGS ;1;379;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;290;1376.96,-868.2607;Inherit;False;345.5028;179.4201;DEBUG SETTINGS ;3;293;353;291;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;390;1381.371,-402.9673;Inherit;False;321.6667;112;DESF Common ASE Compile Shaders;1;391;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;392;726.2145,-683.399;Inherit;False;DESF Core Surface;4;;38532;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,1,1432,1,1433,1,1434,1,1491,0,1284,0,1446,0,307,0,312,0,1318,0,249,0,1319,0,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.CommentaryNode;396;1097.177,-979.2913;Inherit;False;271;139;_RECEIVE_SHADOWS_OFF;1;397;;0,0,0,1;0;0
Node;AmplifyShaderEditor.StaticSwitch;397;1105.177,-940.2913;Inherit;False;Property;_RECEIVE_SHADOWS_OFF;Receive Shadows;2;0;Create;False;0;0;0;True;0;False;0;0;0;True;_RECEIVE_SHADOWS_OFF;Toggle;2;Key0;Key1;Fetch;True;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;389;1127.694,-678.6375;Inherit;False;DESF Module Detail;67;;39592;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.FunctionNode;391;1392.371,-365.9673;Inherit;False;DESF Common ASE Compile Shaders;-1;;39591;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;293;1570.695,-830.256;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;353;1388.431,-760.1531;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;14;0;Create;True;1;;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;379;1400.669,-949.5179;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;291;1389.189,-830.5454;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
...
ASEEND*/
//CHKSM=DB49F657A37E61B95102FBBEC5F31E2466C2562C